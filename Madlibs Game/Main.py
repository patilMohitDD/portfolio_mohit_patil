...
# Taking the adjectives, Nouns, verbs from the User
adj_1 = input("Enter the adjective:- ")
adj_2 = input("Enter the adjective:- ")
verb_1 = input("Enter the Verb:- ")
verb_2 = input(("Enter the Verb:- "))
noun_1 = input("Enter the Noun:- ")
noun_2 = input("Enter the Noun:- ")
